...
// Converted to ES module for PaintBrain Swatch Studio
...
// ES module export — usage: import { ntcName } from './ntc'
// Returns [nearestHex, colorName, exactMatch]
export function ntcName(hex) {
  return ntc.name(hex)
}
